...
wget -qO - https://download.sublimetext.com/sublimehq-pub.gpg \
  | gpg --dearmor -o /etc/apt/keyrings/sublime-text.gpg

# Add Sublime Text repository
echo "deb [arch=$(dpkg --print-architecture) signed-by=/etc/apt/keyrings/sublime-text.gpg] https://download.sublimetext.com/ apt/stable/" \
